...
public:
  ...
  void write_int8   (const int8& data)    { write_any_data(&data, sizeof(data)); }
  ...
  void write_uint8  (const uint8& data)   { write_any_data(&data, sizeof(data)); }
  ...
  int8    read_int8()    { int8    data; read_any_data(&data, sizeof(data)); return data; }
  ...
  uint8   read_uint8()   { uint8   data; read_any_data(&data, sizeof(data)); return data; }
